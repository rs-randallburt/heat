...
from heat.engine import resource, scheduler
from heat.tests import utils
from heat.tests.common import HeatTestCase

from ..engine.plugins import cloudnetworks  # noqa

try:
    from pyrax.exceptions import NotFound
except ImportError:
    from ..engine.plugins.cloudnetworks import NotFound  # noqa
...
class CloudNetworkTest(HeatTestCase):
    ...
    def test_attributes(self, mock_client):
        ...
        self.assertEqual(expect_label, res.FnGetAttr('label'))
        self.assertEqual(expect_cidr, res.FnGetAttr('cidr'))
